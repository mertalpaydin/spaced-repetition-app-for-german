...
| `cycle-28-glossed-verification.md` | 29 Aug | First completed two-pass verification, 80 items all hand audited. Pass disagreements 2 of 80. Content filtering decided. |
